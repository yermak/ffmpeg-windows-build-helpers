...
#    config_options="$init_options --enable-libcaca --enable-gray --enable-libtesseract --enable-fontconfig --enable-gmp --enable-gnutls --enable-libass --enable-libbluray 
#--enable-libbs2b --enable-libflite --enable-libfreetype --enable-libfribidi --enable-libgme --enable-libgsm --enable-libilbc --enable-libmodplug 
#--enable-libmp3lame --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libopus --enable-libsnappy --enable-libsoxr --enable-libspeex --enable-libtheora --enable-libtwolame --enable-libvo-amrwbenc --enable-libvorbis --enable-libvpx --enable-libwebp --enable-libzimg --enable-libzvbi --enable-libmysofa --enable-libaom --enable-libopenjpeg  --enable-libopenh264"

    config_options="$init_options --enable-libopenjpeg --enable-libtwolame --enable-fontconfig --enable-gnutls --enable-libmp3lame --enable-libfdk-aac "
    config_options+="--disable-filters --enable-filter=aresample --disable-devices "
    config_options+="--disable-protocols --enable-protocol=pipe --enable-protocol=file --enable-protocol=concat "
    config_options+="--disable-bsfs "
    config_options+="--disable-parsers --enable-parser=mpegaudio "
#    config_options+="--disable-demuxers --enable-demuxer=mp3 --enable-demuxer=xwma --enable-demuxer=m4a --enable-demuxer=asf --enable-demuxer=concat "
    config_options+="--disable-decoders --enable-decoder=mp3  --enable-decoder=mp3adufloat --enable-decoder=mp3adu --enable-decoder=mp3on4 --enable-decoder=mp3on4float " 
    config_options+="--enable-decoder=wmalossless --enable-decoder=wmapro  --enable-decoder=wmav1 --enable-decoder=wmav2 "
#    config_options+="--disable-encoders --enable-encoder=aac --enable-libfdk_aac "
    config_options+="--disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages "
    config_options+="--disable-hwaccels  "
    config_options+="--disable-zlib --disable-bzlib --disable-lzma"
